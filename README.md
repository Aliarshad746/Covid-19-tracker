This project was bootstrapped with [Create React App](https://github.com/facebookincubator/create-react-app). Final project website [Covid-19-tracker](https://covid-19-tracker-a9a6f.web.app/).
